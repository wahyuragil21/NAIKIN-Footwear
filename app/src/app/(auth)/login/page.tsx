import { MyResponse } from "@/app/types"
                            ...
                            <div className="w-full flex-1 mt-8">
                                ...
                                <div className="mx-auto max-w-xs">
                                    <form action={handleLogin}>
                                        ...
                                        />
                                        <ButtonComp/>
                                        <p className="mt-6 text-xs text-gray-600 text-center"> Dont have an account? <Link href="/register" className="hover:text-blue-600">Sign Up</Link>
                                        </p>
                                    </form>
                                </div>
                            </div>
